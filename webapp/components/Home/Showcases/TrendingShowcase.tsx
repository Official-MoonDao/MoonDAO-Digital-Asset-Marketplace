...
export default function TrendingShowcase({
  ...
  return (
    <div
      id="trending-showcase"
      className="mt-14 md:mt-20 flex flex-col w-full items-center py-[10%] md:py-[5%] md:px-[2%] bg-[#251d2e] object-cover rounded-tl-[12vw] rounded-br-[12vw] lg:rounded-br-[10vw] lg:rounded-tl-[10vw]"
    >
