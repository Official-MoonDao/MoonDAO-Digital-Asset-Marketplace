...
export default function NewShowcase({
  ...
  return (
    <div
      id="new-showcase"
      className="mt-12 md:mt-16 md:mb-12  flex flex-col items-center"
    >
      ...
      <section
        ...
        } mt-10 md:mt-16 flex flex-col gap-10 md:grid md:grid-cols-2 md:grid-flow-row md:gap-12 xl:gap-20`}
      >
        {collections
