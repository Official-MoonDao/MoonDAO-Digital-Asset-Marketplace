      ...
      */}
      <div className="mt-9 md:mt-12 flex flex-col items-center gap-12 lg:hidden">
        {dummyData.slice(4).map((e, i) => (
          <TrendingThumbnail key={i} name={e.name} img={e.img} holders={e.holders} floor={e.floor} number={e.number} />
        ))}
      </div>
      ...
      <ArrowButton text="See all" position={"mt-9 lg:mt-12"} link={"/"} />
    </div>
  );
}

const dummyData = [
  { name: "Lorem Ipsum", img: "/trendingthumbnail.png", holders: 20, floor: 20000, number: 102, link: "/" },
  { name: "Lorem Ipsum", img: "/trendingthumbnail2.png", holders: 20, floor: 20000, number: 102, link: "/" },
  { name: "Lorem Ipsum", img: "/trendingthumbnail3.png", holders: 20, floor: 20000, number: 102, link: "/" },
  { name: "Lorem Ipsum", img: "/trendingthumbnail4.png", holders: 20, floor: 20000, number: 102, link: "/" },
  { name: "Lorem Ipsum", img: "/trendingthumbnail.png", holders: 20, floor: 20000, number: 102, link: "/" },
  { name: "Lorem Ipsum", img: "/trendingthumbnail2.png", holders: 20, floor: 20000, number: 102, link: "/" },
  { name: "Lorem Ipsum", img: "/trendingthumbnail3.png", holders: 20, floor: 20000, number: 102, link: "/" },
  { name: "Lorem Ipsum", img: "/trendingthumbnail4.png", holders: 20, floor: 20000, number: 102, link: "/" },
